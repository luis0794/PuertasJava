...
public class MenuPuertas extends JFrame {
	...
	public MenuPuertas(String usuario) {
		...
		JButton btnPuerta5 = new JButton("Puerta 5");
		btnPuerta5.setBounds(293, 280, 213, 93);
		panel.add(btnPuerta5);
		
		JButton btnPuerta6 = new JButton("Puerta 6");
		...
		panel_1 = new JPanel();
		panel_1.setBounds(0, 0, 784, 441);
		contentPane.add(panel_1);
		panel_1.setLayout(null);
		panel_1.setBackground(new Color(0, 102, 153));
		
		JButton button = new JButton("Puerta 1");
		button.setBounds(46, 168, 213, 93);
		panel_1.add(button);
		
		JButton button_1 = new JButton("Puerta 2");
		button_1.setBounds(293, 168, 213, 93);
		panel_1.add(button_1);
		
		JButton button_2 = new JButton("Puerta 3");
		button_2.setBounds(545, 168, 213, 93);
		panel_1.add(button_2);
		
		JButton button_3 = new JButton("Puerta 4");
		button_3.setBounds(46, 280, 213, 93);
		panel_1.add(button_3);
		
		JButton button_4 = new JButton("Puerta 5");
		button_4.setBounds(293, 280, 213, 93);
		panel_1.add(button_4);
		
		JButton button_5 = new JButton("Puerta 6");
